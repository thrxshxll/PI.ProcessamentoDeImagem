...
# para cada pixel (i, j), aplicada a ordem de vizinho mais próximo nos elementos (i, j+1), (i+1), (i+1, j+1)
for l in range(0, height*2-1, 2):
    for c in range(0, width*2-1, 2):
        extanded[l,c+1] = extanded[l, c]
        extanded[l+1,c] = extanded[l, c]
        extanded[l+1,c+1] = extanded[l, c]


# print('extanded:', np.shape(extanded))
