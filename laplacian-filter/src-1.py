...
for i in range(1, height-1):
    for j in range(1, width-1):
        ...
        '''
            Máscara de filtragem que gera um resultado isotrópico para rotações em incrementos de 90°, onde
            o centro da máscara é -1.
        '''
        hold = 0
        hold += img2mat[i-1, j]
        hold += img2mat[i+1, j]
        hold += img2mat[i, j-1]
        hold += img2mat[i, j+1]
        hold -= (4 * img2mat[i, j]) # valor lapaciano do pixel f(x,y)
...
mat2img.save('laplaciano-4'+file_name)